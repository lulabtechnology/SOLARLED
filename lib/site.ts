export const siteConfig = {
  brand: 'Solarled',
  phone: '310-8213',
  whatsapp: '50767882092',
  whatsappDisplay: '6788-2092',
  email: 'ventas@solarledpty.com',
  address: 'PH Financial Park, Blvd. Costa del Este, Piso 17, Ciudad de Panamá',
  coverage: 'Atención de proyectos desde Colón hasta Chiriquí',
  whatsappMessage: 'Hola Solarled, quiero una evaluación para reducir mi factura eléctrica con paneles solares.'
};
...
export const faqs = [
  ...
  { question: '¿La energía solar ayuda a bajar la factura eléctrica?', answer: 'Sí. Uno de los objetivos principales del sistema es reducir el peso del gasto eléctrico con una solución bien diseñada e instalada.' }
];

export const processSteps = [
  { title: 'Evaluación', description: 'Se revisa el tipo de propiedad, la ubicación y el consumo para entender si el proyecto es viable y cómo debe plantearse.' },
  { title: 'Propuesta', description: 'Se presenta una solución clara, enfocada en ahorro, rendimiento, equipos certificados y valor a largo plazo.' },
  { title: 'Instalación', description: 'Se ejecuta con criterio técnico, orden y atención al detalle para que el sistema responda como debe.' },
  { title: 'Acompañamiento', description: 'Después de instalar, se mantiene el acompañamiento para que el cliente tenga claridad y confianza.' }
];
